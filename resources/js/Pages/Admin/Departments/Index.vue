...
const submit = () => {
    if (isEditing.value) {
        form.put(route('admin.departments.update', editId.value), {
            onSuccess: () => reset()
        });
    } else {
...
<template>
    ...
    <AdminLayout>
        <template #header>
            <h2 class="font-semibold text-xl text-gray-800 leading-tight">Master Data: departments</h2>
        </template>
        ...
        <div class="py-12">
            <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 space-y-6">
                ...
                <div class="p-6 sm:p-8 bg-white shadow sm:rounded-lg">
                    <h3 class="text-lg font-medium text-gray-900 mb-4">{{ isEditing ? 'Edit department' : 'Add New department' }}</h3>
