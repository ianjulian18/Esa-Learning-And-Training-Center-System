...
const form = useForm({
    ...
    passing_grade: props.course.passing_grade,
    status: props.course.status,
    thumbnail: null as File | null,
});

const thumbnailPreview = ref<string | null>(props.course.thumbnail || null);
...
const submit = () => {
    // We use POST with _method PUT because we are uploading files
                ...
                <div class="px-4 py-6 sm:p-8">
                    <div class="grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
                        ...
                        <div class="sm:col-span-2">
                            ...
                            <div class="mt-2">
                                <input type="text" id="code" v-model="form.code" required class="block w-full rounded-md border-0 py-1.5 text-slate-900 shadow-sm ring-1 ring-inset ring-slate-300 placeholder:text-slate-400 focus:ring-2 focus:ring-inset focus:ring-primary-600 sm:text-sm sm:leading-6" />
                            </div>
                        ...
                        <div class="col-span-full">
                            ...
                            <p class="mt-2 text-sm text-slate-500">Leave blank to keep existing thumbnail.</p>
